...
<template>
  ...
  <AppLayout>
    <div class="flex min-h-screen">
      <SecondSidebar current-route="inventory.items.create" />
      ...
      <div class="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 class="text-2xl font-bold">Tambah Item Inventaris</h1>
          <p class="text-muted-foreground">Tambahkan item baru ke inventaris peternakan</p>
        </div>
      </div>
