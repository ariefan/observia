...
// Data for best weight component
...
// Functions for best weight component
const topWeightLivestock = computed(() => {
    return topRankings.value.weight_rankings.slice(0, 3);
});
        ...
        <div class="flex-1 p-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    <!-- Left side - Best weight component -->
                    <div class="lg:col-span-2">
                        <Card>
                            <CardHeader>
                                <div class="flex justify-between items-center">
                                    <div>
                                        <CardTitle class="md:text-lg text-base lg:text-xl">Bobot terbaik</CardTitle>
                                        <CardDescription>Rank Ternak</CardDescription>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <span class="text-sm text-muted-foreground">Pengecekan hari ini</span>
                            ...
                            <CardContent>
                                ...
                                <div v-else-if="topWeightLivestock.length === 0"
                                ...
                                <div v-else class="flex flex-col items-center gap-6">
                                    ...
                                    <div class="flex justify-center gap-12 items-end">
                                        ...
                                        <div v-if="topWeightLivestock[1]"
                                            ...
                                            <Avatar class="border-2 border-primary mr-2" shape="circle">
                                                ...
                                                <AvatarFallback>{{ topWeightLivestock[1].name.charAt(0).toUpperCase() }}
                                                </AvatarFallback>
                                            </Avatar>
                                        ...
                                        <div v-if="topWeightLivestock[0]"
                                            ...
                                            <Avatar class="border-2 border-primary mr-2" shape="circle">
                                                ...
                                                <AvatarFallback>{{ topWeightLivestock[0].name.charAt(0).toUpperCase() }}
                                                </AvatarFallback>
                                            </Avatar>
                                        ...
                                        <div v-if="topWeightLivestock[2]"
                                            ...
                                            <Avatar class="border-2 border-primary mr-2" shape="circle">
                                                ...
                                                <AvatarFallback>{{ topWeightLivestock[2].name.charAt(0).toUpperCase() }}
                                                </AvatarFallback>
                                            </Avatar>
                                    ...
                                    <p class="text-sm">Ternak dengan bobot terbaik ini menunjukkan pertumbuhan dan
                                        kesehatan yang optimal,
                                        menjadi indikator kualitas manajemen peternakan yang baik.
                                    </p>

                                    <!-- View All Link - Hidden on weight page since we're already there -->
                                    <!-- This link would normally go to /productivity/weight but we're already on that page -->
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <div class="lg:col-span-2">
                        <div class="space-y-4">
                            <div v-if="rankings.length === 0" class="text-center py-12">
                                <IconScaleOutline class="h-16 w-16 text-muted-foreground mx-auto mb-4" />
