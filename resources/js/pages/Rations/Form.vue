                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="mt-4 p-4 border rounded-md" v-if="form.items.length > 0">
                                            ...
                                            <div v-for="(item, index) in form.items" :key="index"
                                                ...
                                                <div>
                                                    <Combobox v-if="!restock">
                                                        ...
                                                        <ComboboxList class="max-h-48 overflow-y-auto">
                                                            ...
                                                            <ComboboxGroup>
                                                                <ComboboxItem v-for="feedOption in feedItems"
                                                                    :key="feedOption.id" :value="feedOption"
                                                    ...
                                                    <InputError class="mt-1"
                                                        :message="form.errors[`items.${index}.feed`]" />
                                                ...
                                                <div>
                                                    <Input :id="'quantity_' + index" v-model="item.quantity"
                                                        type="number" class="mt-1 block w-full h-8" required min="0"
                                                        step="any" />
                                                    <InputError class="mt-1"
                                                ...
                                                <div>
                                                    ...
                                                    <InputError class="mt-1"
                                                        :message="form.errors[`items.${index}.price`]" />
                                                </div>
