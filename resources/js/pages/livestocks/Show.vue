    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 p-4 max-w-7xl mx-auto">
        ...
        <CardContent class="pt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 text-white font-sans">
            ...
            <div class="rounded-2xl flex flex-col">
              <div class="bg-teal-500 dark:bg-teal-200 text-white dark:text-black rounded-t-lg px-4 py-2 flex items-center gap-2">
                <Mars />
                <span>Kambing</span>
              </div>
              <div class="bg-white dark:bg-zinc-800 dark:text-white text-teal-800 text-center py-4 rounded-b-lg text-5xl font-semibold">
            ...
            <!-- Milk Section -->
            <div class="rounded-2xl flex flex-col">
              <div class="bg-cyan-500 dark:bg-cyan-200 text-white dark:text-black rounded-t-lg px-4 py-2 flex items-center gap-2">
                <Venus />
                <span>Susu</span>
              </div>
              <div class="bg-white dark:bg-zinc-800 dark:text-white text-cyan-800 text-center py-4 rounded-b-lg text-5xl font-semibold">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 text-white font-sans">
              ...
              <div class="rounded-lg flex flex-col border border-primary/20 dark:border-primary/80">
                  <!-- Header -->
                  <div
                      class="bg-primary text-white dark:text-black rounded-t-lg px-4 py-2 flex items-center gap-2">
              ...
              <Card class="border border-primary/20 dark:border-primary/80">
                <CardContent class="p-4">
                  ...
                  <LineChart
                    ...
                    :dataPoints="[1,1.2,1.1,3.5,4,5,6,7,3,8,10,11]"
              ...
              <Card class="border border-primary/20 dark:border-primary/80">
                <CardContent class="p-4">
                  <Alert variant="danger" class="mb-2">
                    ...
                    <AlertDescription class="text-sm">Perkembangan bobot ternakmu hari ini menurun 4kg atau -10% dari bobot sebelumnya</AlertDescription>
                  </Alert>
                  <LineChart
                    :labels="['Jan','Feb','Mar','Apr','Mei','Jun','Jul','Agu','Sep','Okt','Nov','Des']"
                    :dataPoints="[10,30,40,60,70,80,80,90,100,80,110,130]"
